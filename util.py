...
#	embeddings_ordered = np.load(embedding_file)
	...
	#
	embeddings_dict = {}
	embeddings_dict = pickle.load(open(embedding_file, "rb"), encoding="latin1")
	...
	dict_sup_gs_scores = pickle.load(open(dict_node_scores_file_name, "rb"), encoding="latin1")
	...
	dict_node_sampled_neighbors = pickle.load(open(dict_node_sampled_neighbors_file_name, "rb"), encoding="latin1")
