...
def neuralNetModel(features, labels, mode):	
	...
	layer_1 = tf.compat.v1.layers.dense(features['mu_selected'],dimension,activation=None)

	# layer 2 for the left nodes
	layer_2 = tf.compat.v1.layers.dense(features['mu_left'],dimension,activation=None)

	# layer 3 for the selected nodes
	layer_3 = tf.compat.v1.layers.dense(features['mu_v'],dimension,activation=None)
